...
# Your legal name
first_name = "Leonardo"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Rodrigues"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Fragoso"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "21980292791"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Rio de Janeiro"                  # Los Angeles, San Francisco, etc.
'''
