...
search_terms = ["Desenvolvedor Python", "Python Developer", "Desenvolvedor Django", "Django Developer", "Desenvolvedor Flask", "Flask Developer", "Full Stack Developer", "Desenvolvedor Full Stack", "Backend Developer", "Desenvolvedor Backend", "Node.js Developer", "Desenvolvedor Node.js", "Desenvolvedor de Automações", "RPA Developer", "API Developer"]

# Search location, this will be filled in "City, state, or zip code" search box. If left empty as "", tool will not fill it.
search_location = "Brasil"               # Some valid examples: "", "United States", "India", "Chicago, Illinois, United States", "90001, Los Angeles, California, United States", "Bengaluru, Karnataka, India", etc.
...
location = ["Rio de Janeiro", "Remote", "Brasil"]                      # (dynamic multiple select) - Prioriza RJ e Remote
...
# ATUALIZADO: Removidas tecnologias mainstream (.NET, PHP, Ruby) que estavam causando perda de 55+ oportunidades
# Mantidas apenas palavras que realmente indicam requisitos incompatíveis
bad_words = ["US Citizen", "USA Citizen", "No C2C", "No Corp2Corp", "Embedded Programming", "CNC", "COBOL", "FORTRAN", "Mainframe", "AS/400"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]

# NOVA CONFIGURAÇÃO: Bad words contextuais (opcional - para uso futuro)
# Estas tecnologias só seriam rejeitadas se fossem requisitos PRINCIPAIS, não apenas mencionadas
contextual_bad_words = []  # Para implementação futura: [".NET Core required", "PHP only", "Ruby on Rails primary"]
...
# ATUALIZADO: Aumentado de 3 para 8 anos para não perder oportunidades (muitas empresas colocam requisitos altos mas são flexíveis)
current_experience = 8             # Integers > -2 (Ex: -1, 0, 1, 2, 3, 4...)
# Dica: Muitas vagas pedem "5+ anos" mas aceitam candidatos com menos experiência se tiverem as skills certas
##
