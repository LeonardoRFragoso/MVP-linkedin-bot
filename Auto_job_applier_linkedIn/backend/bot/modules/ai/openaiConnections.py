...
from backend.bot.config.secrets import *
from backend.bot.config.settings import showAiErrorAlerts
from backend.bot.config.personals import ethnicity, gender, disability_status, veteran_status
from backend.bot.config.questions import *
from backend.bot.config.search import security_clearance, did_masters

from backend.bot.modules.helpers import print_lg, critical_error_log, convert_to_json
from backend.bot.modules.ai.prompts import *
...
def ai_generate_resume(
    ...
    '''
    Function to generate resume. Takes in user experience and template info from backend.bot.config.
    '''
    pass
