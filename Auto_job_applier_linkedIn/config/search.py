...
search_terms = ["Desenvolvedor Python"]
...
experience_level = ["Entry level", "Mid-Senior level"]              # (multiple select) "Internship", "Entry level", "Associate", "Mid-Senior level", "Director", "Executive"
