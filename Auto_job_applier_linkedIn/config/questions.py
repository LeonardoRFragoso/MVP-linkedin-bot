...
default_resume_path = "all resumes/default/CV - Leonardo Fragoso _ Desenvolvedor Full Stack 06-02.pdf"      # (In Development)
...
desired_salary = 8000          # Salário em reais (R$ 8.000). Do NOT use quotes
'''
